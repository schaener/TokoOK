...
import { StyledForm } from '../components/SearchBox/search-box.style'
...
const MobileSearchForm = styled(StyledForm)`
width: auto;
...
height: 50px;
margin-bottom: 10px;
background-color: ${props => props.isActive ? props.theme.colors.primary.regular : props.theme.colors.disableBtn};
...
background-color: ${props => props.isActive ? props.theme.colors.activeButton : 'transparent'} ;
color: ${props => props.isActive ? props.theme.colors.white : props.theme.colors.black};
font-size: 14px
`
